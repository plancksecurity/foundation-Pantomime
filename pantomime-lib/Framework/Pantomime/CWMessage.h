...
/*!
 @const PantomimeMessageUidExpungeCompleted
 @discussion This notification is posted when UIDPLUS call to UID_EXPUNGE completed
 */
extern NSString * _Nonnull const PantomimeMessageUidExpungeCompleted;
