...
//@property (nonatomic) ConnectionTransport connectionTransport; //BUFF:
@property (nonatomic, nullable, strong) id<CWLogging> logger;
//@property (nonatomic) dispatch_queue_t writeQueue; //BUFF:
...
//}
//
//- (void)setWriteQueue: (dispatch_queue_t)writeQueue
//{
